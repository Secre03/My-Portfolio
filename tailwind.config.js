...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        "hero":    ["clamp(3.2rem, 9vw, 8rem)",  { lineHeight: "1",    fontWeight: "900" }],
        "h2":      ["clamp(2rem, 5vw, 3.5rem)",  { lineHeight: "1.1",  fontWeight: "900" }],
        "h2-lg":   ["clamp(2.5rem, 6vw, 5rem)",  { lineHeight: "1.1",  fontWeight: "900" }],
